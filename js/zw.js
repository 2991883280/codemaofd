...
},
{
	...
	bm:'管理部门',
	bmz:'暂无',
	gznr:'1、擅长excel等表格制作与分析，及数据可视化制作<br>2、善于表达沟通，诚实守信，责任心强，讲求效率，具有良好的团队协作精神<br>3.擅长用图表有效表达自己的分析观点，使分析结果一目了然。图形的选择、版式的设计、颜色的搭配等，需要掌握一定的设计原则。<br>4.掌握数据分析基本原理与一些有效的数据分析方法，并能灵活运用到实践中，以便有效的开展数据分析。基本的分析方法有：对比分析法、分组分析法、交叉分析法、结构分析法、漏斗图分析法、综合评价分析法、因素分析法、矩阵关联分析法等。高级的分析方法有：相关分析法、回归分析法、聚类分析法、判别分析法、主成分分析法、因子分析法、对应分析法、时间序列等。',
	zwdj:'职务等级：技术员--高级技术员--首席技术员'
},
]
